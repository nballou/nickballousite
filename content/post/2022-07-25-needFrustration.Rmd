...
In the table below, I've given some examples of need-satisfying and need-frustrating experiences in games. We know that games are really good at satisfying needs, generally. But while we know that need-frustrating experiences are part of gaming too, we don't really know what they look like---when they occur, and how they feel when they happy. (Spoiler: the only reason I'm able to give the examples is because of the the results of the study!)
...
We decided to address this by interviewing players about their experiences. We ended up interviewing 12 players, each for about an hour. We transcribed the interviews, and then used a method called grounded theory to develop a working model of how need frustration was occuring, and what consequences it had for players. This is an intellectually challenging process, because the goal is to constantly be challenging the model and trying to "break" it---in fact, in this method, you choose whom to interview one person at a time, so that you can select a person who would be most likely to either enrich or contradict your ideas.

We interviewed a total of 12 players from 8 different countries who each played a variety of different games, and who included a variety of ages, genders, and relationships to gaming.
...
<figure>
  <img src="/img/groundedTheoryModelTransparent.png" width="600"/>
...
The diagram has too many components for me to describe them all here---every line in the figure needs to be supported by multiple quotes from participants. I'll focus here on the two bits I find most important: the need-frustrating *situations*, and player *expectations*, and briefly describe how this might cause people to change their behavior.
...
Being \textit{disconnected from other players} arose when players had disagreements with their teammates, felt that a skill mismatch made for unequal in-game status, and---most commonly---when players were harassed by other players:
